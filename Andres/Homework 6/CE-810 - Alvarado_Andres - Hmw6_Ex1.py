...
def apply_boundary_conditions(K, Kg, F, fixed_dofs):
    """
    Extract free DOF submatrices/vectors.
    """
    ndof = K.shape[0]
...
if __name__ == "__main__":
    ...
    L_total = 120 #Longitude
    num_elems = 8 #Number of Elements
    ...
    supports = {
        0: [1, 1, 1, 1, 0, 0], #1: Fixed, 0: Free.
        num_nodes - 1: [1, 1, 1, 1, 0, 0], #1: Fixed, 0: Free.
    }
    ...
    M_ref = 1  # Reference Moment (kip-in)
    for e in range(num_elems):
        Fx2 = 0
        Mx2 = 0
        My1 = 0
